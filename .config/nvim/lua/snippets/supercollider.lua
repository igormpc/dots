...
local rnd = function() return f(function() return "" .. math.random() .. "" end, {}) end
...
local my_sc_snippets = {
	...
	-- Device setup
	s("blackhole", fmt([[s.options.outDevice_("BlackHole {}ch");]], {i(1, "64")})),
...
{ i(1, "pat"), i(2, "\\freqshift"), i(3, "\\channelized"), i(4, "0.5") },
		{ delimiters = "{}" })
	),
	...
	-- Buffer stuff
	s("b", {i(1, "b"), t(" "), t("="), t(" "),t("Buffer.read("), t("s, \""), i(2, "~/testsound/pots.wav"), t("\".asAbsolutePath)")}),
	...
	headerFormat: "WAV",
	sampleFormat: "int32",
	options: s.options.numOutputBusChannels_({}),
	duration: {},
	action: {}
	) ]],{
	...
	s("plambda", {
		...
		t({"Ppar([", ""}),
		t({"Pbind(", ""}),
		i(1, "\\dur"), t(","), i(2, "0.125"), t({",", ""}),
		i(3, "\\octave"), t(","), i(4, "4"), t({",", ""}),
		i(5, "\\degree"), t(","), i(6, "Plet(\\melody, pattern: Pwhite(2, 07))"), t({""}),
		t({"", "),", ""}),
		t({"Pbind(", ""}),
		i(7, "\\dur"), t(","), i(8, "0.125"), t({",", ""}),
		i(9, "\\octave"), t(","), i(9, "3"), t({",", ""}),
		i(10, "\\degree"), t(","), i(11, "Pget(\\melody, default: 1, repeats: inf)"), t({"", ""}),
		t({")", ""}),
		t({"]", ",", ""}),
		t({"inf)", ""}),
		t({")"}),
	...
	s("pspawn", {
		t({"Pspawn(", "Pbind(", ""}),
		t("\\method,"), i(1, "Prand([\\par, \\seq, \\wait, \\suspendAll], inf)"), t({",", ""}),
		t({"\\delta, "}), i(2, "Pwhite(1, 5, inf) * 0.125"), t({",", ""}),
		t({"\\pattern, Pfunc {|ev|", ""}),
		t({"var delta = ev[\\delta] ? 1;", ""}),
		t({"Pbind(", ""}),
		i(3, "\\degree"), t(","), i(4, "Pseries(rrand(0, 10), #[-1, 1].choose, rrand(4, 10))"), t({", "," "}),
		i(5, "\\dur"), t(","), i(6, "delta/10" ), t({"", ")"}),
		t({ "},", ")", ")"}),
		}
	),
